                ...
                <div className='max-w-[1000px]'>
                    ...
                    <section className='flex gap-5'>
                        <div className='flex-1'>
                            <img src={featuredImg} className='h-64 w-full' alt="" />
                        </div>
                        <div className='flex-1'>
                            <h3 className="mb-1 text-2xl font-bold">March 20, 2023</h3>
                            <h3 className="mb-1 text-2xl font-bold">where i can get some?</h3>
